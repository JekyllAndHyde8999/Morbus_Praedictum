# Generated by Django 2.2.4 on 2019-11-01 10:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Patient_Blood_Group', models.IntegerField(choices=[(1, 'A+'), (2, 'A-'), (3, 'B+'), (4, 'B-'), (5, 'O+'), (6, 'O-'), (7, 'AB+'), (8, 'AB-')])),
                ('Patient_Blood_Donation', models.IntegerField(choices=[(0, 'Yes'), (1, 'No')])),
