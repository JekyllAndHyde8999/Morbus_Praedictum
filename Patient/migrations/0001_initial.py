    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Patient_Blood_Group', models.IntegerField(choices=[(1, 'A+'), (2, 'A-'), (3, 'B+'), (4, 'B-'), (5, 'AB+'), (6, 'AB-'), (7, 'O+'), (8, 'O-')], validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(8)])),
