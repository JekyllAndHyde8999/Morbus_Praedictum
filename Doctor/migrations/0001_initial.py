...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='ClinicAddress',
            fields=[
                ('ClinicAddress_ID', models.AutoField(auto_created=True, default=1, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Doctor_Address', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='Doctor.ClinicAddress')),
